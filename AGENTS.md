...
- Keep reasoner contexts data-only and capability-free. The orchestrator—not a reasoner—owns gateway access, bounds, evidence provenance, policy invocation, lifecycle, persistence, and audit.
