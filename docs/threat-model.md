...
| Partial or duplicate processing | Conflicting results/actions | Idempotency keys; application-generated canonical action IDs; unique constraints; explicit lifecycle; immutable terminal results | Retry, cross-execution duplicate recommendation, and concurrency tests |
